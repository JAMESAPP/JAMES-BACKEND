...
class RefuelsControllerTest < ActionController::TestCase
  ...
  test "should create refuel" do
    assert_difference('Refuel.count') do
      post :create, refuel: { KM: @refuel.KM, amount: @refuel.amount, date: @refuel.date, gas_station: @refuel.gas_station, observation: @refuel.observation, price: @refuel.price }
    end
  ...
  test "should update refuel" do
    patch :update, id: @refuel, refuel: { KM: @refuel.KM, amount: @refuel.amount, date: @refuel.date, gas_station: @refuel.gas_station, observation: @refuel.observation, price: @refuel.price }
    assert_redirected_to refuel_path(assigns(:refuel))
  end
